...
},
{
	...
	resB : "Il lance une recherche internet et tombe sur des sites pornos. Autant apprendre seul ! ",
	response : "resA",
...
},
{
	...
	resB: "Au début tu rigoles, puis tu calme le jeu , mais comme tu vois que Damien est sérieux tu préfère prévenir un adulte.",
	response: "resB",
	ifResA: "Les fausses rumeurs se sont incontrôlablement propagés. Sous la pression Nicolas a fait une tentative de suicide.", 
	ifResB: "Tu as bien fait. Le cyber-harcèlement est puni par la loi, au même titre que le harcèlement classique. Les premiers responsables en cas de harcèlement en ligne sont les auteurs des propos en cause.Un intermédiaire ne sera responsable que si : il a eu connaissance des messages publiés, et s'il n'a pas agi rapidement pour faire retirer ces messages dès qu'il en a eu connaissance.(www.service-public.fr)",
...
},
{
	...
	response: "resB",
	ifResA: "A force de temps passé sur Internet, un des enfant à eu le cerveau liquéfié. L’autre a fait une crise d’épilepsie et a commencé à voir des hélicopter en liège partout. Et l’autre s’est perdu dans les toilettes.",
...
},
{
	...
	resA : "Mona tente sa chance, forcement, c’est pas rien 1500€ ! Et si sa cousine a gagné, c’est que le site est sur!",
