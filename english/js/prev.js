...
},
{
	...
	resB : "He searches on Internet and falls on a porn sites. He decides to learn alone!",
	response : "resA",
...
},
{
	...
	resA : "Julie must pay right away! She wants to keep her computer, which became unusable, and she didn't want break the law.",
	resB : "Julie is worried and explains her mistake to an adult!",
	response : "resB",
	ifResA : "Too bad, this Hadopi message was a hacking, a badly-minded person took control of her computer and her data to get her money.",
	ifResB : "Well played, this Hadopi message was a hacking and they wanted to get her money.",
	genre : "../../res/arnaques.png"
},
{
	...
	response: "resB",
	ifResA: "She clicks on the link. It is stupid ... the site was a fake, a hacker emptied her account ... dying of hunger the family had no choice but to eat the dog and the last child ...",
...
{
	situation: "In middle school, a rather violent incident broke out between Nicolas and your friend Damien. Apparently, Damien was angry with Nicholas and he wants to take revenge on him. He wants to ruin his life on the Internet.",
	resA: "You laugh at the same time when Damien writes false rumors on the social networks. And you and your friends relay everything.", 
	resB: "At first you laugh, then you try to calming matters, but as you see that Damien is serious you prefer to warn an adult.",
	response: "resB",
	ifResA: "False rumors have uncontrollably spread. Under pressure Nicolas made a suicide attempt.", 
	ifResB: "You did well. Cyber-bullying is punishable by law, as is conventional harassment. Those responsible for online harassment are the perpetrators. An intermediary will only be responsible if: he or she is aware of the messages published, and if he / she has not acted quickly to have these messages removed as soon as possible (Www.service-public.fr).",
	genre : "../../res/cyberHarcelement.jpg"
 
},
{
	situation: "A father leaves his digital tablet in the hands of his children without special supervision.",
	resA: "So what? There are no dangers ... these are just games ...",
	resB: "It's not a good idea. Children should not be unattended even on the Internet.",
	response: "resB",
	ifResA: "One of the two children has the idea to search for games on Google. Unfortunately, they see pornographic content. Under shock, one of the two dies of cardiac arrest and the other one throw himself out of the window, impaling himself on the balustrade of the neighbor.",
	ifResB: "Do not leave young children alone on the Internet: 90% of children have been at least once time confronted with unsuitable content. Report images and child pornography on the site http://internet-signalement.gouv.fr which is managed by the police. Several million child pornographic images circulate continuously on the Web.",
	genre : "../../res/controlParental.jpeg"
},

{
	situation: "Some parents let their children spend all day on the computer, to the point that they do only that.",
	...
	response: "resB",
	ifResA: "Due to time spent on the Internet, one of the children had the brain liquefied. The other had an epileptic crisis and started seeing cork helicopters everywhere. And the other lost himself in the toilet.",
...
{
	situation : "Mona receives an e-mail of her cousin, explaining to him that she won 1500€ by answering a simple online questionnaire! She advice her to be fast because the drawing lots is every day at 7 pm.",
	resA : "Mona take a chance, because 1500€ it is not nothing !Furthermore, if her cousin won, it is that the site is safe!",
	resB : "Mona phones to her cousin, to have all the information before joining.",
	response : "resB",
	ifResA : "Thanks to the informations entered in the form, the bank account of Mona was emptied and her identity was stolen. The thief also stole the e-mail of all her contacts and tries to rip off her close friends.",
	ifResB : "The cousin of Mona never gained anything!She realizes while it was only a scam!",
	genre : "../../res/hack.jpg"
},

{
	situation: "It's been a while that you notice that one of your friend has changed behavior. He withdraws into himself, has more and more radicals point of view, passes all his time on the social networks and goes away from you.",
	resA: "You worry, you try to speak to him and you tell your concerns to an adult.",
	resB: "He has the right to think what he wants ... it not to you to manage the problems.",
	response: "resA",
...
},
{
	...
	resA: "You feel pain for him and even if you don't appreciate him that much you prefer to warn an adult.",
	resB: "It is not your problem. In truth, you find the photos rather funny.",
	response: "resA",
	ifResA: "The cyberviolence has no temporal limit: it can be practiced all day long or during the night and leave digital tracks (a published photo can live a very long time on the Internet). The author himself, once the attacks published on the Web, cannot control the broadcasting of the contents.",
	ifResB: "The broadcasting of photos became uncontrollable. Charles gone crazy and began to eat some chalk to calm his fears.",
	genre : "../../res/cyberHarcelement.jpg",
},
{ 
...
},
{
	...
	resA: "You ask her for explanations, do not believe her and send her flying.",
	resB: "You ask her for explanations and check her Facebook connection with her.",
	response: "resB",
...
{	 
	...
	resA: "You know, you get lots of insulting messages and you try to calming matters as you can.",
	resB: "You're like a madman ... you're getting excited about the situation.",
	response: "resA",
...
},
{
	...
	resA: "No worries, after all they will not be opposed to the diffusion of the image.",
	resB: "Marc goes to see these friends and asks if he can broadcast the picture.",
	response: "resB",
...
},
{
	...
	resA: "The site is displayed, Horace fill out the form and signes up.",
	resB: "The site is displayed but by rereading, he is aware of a fault in the writing of the address.",
	response: "resB",
...
{
	situation: "Frank meets a middle school’s friend. He has not seen him for several years and yet, his friend is aware of all his life, with many details like the place of his marriage or what he did for his 25 years ...",
	resA: "Shocked, Frank seeks to understand how his friend knows all about this.",
	resB: "Delighted to see that his friend had heard from him, he told her the details he missed.",
	response: "resA",
	ifResA: "Thanks to internet and social networks, Frank's friend read all the informations on the internet! So, check your tracks, do not hesitate to type your name in a search engine to see what information is available on you.",
	ifResB: "Ask questions, and check your tracks, do not hesitate to type your name in a search engine to see what information is available on you.",
	genre: "../../res/reseauSociaux.jpg"
},
{
	situation: "Martin and Kelly met on the Internet. After many passionate discussions, they decide to make a video chat. A few minutes after starting, Kelly proposes to Martin that they  both get undressed.",
	resA: "Martin accepts! They have known each other for 2 months and they communicate by phone. Plus, it's cool!",
	resB: "Martin refuses! He does not want to take risks, even if he really wants it!",
	response: "resB",
